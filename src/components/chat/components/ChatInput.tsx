        ...
        >
            ...
            <div className="px-5 pt-5 pb-2">
              <div className="relative w-16 h-16 rounded-xl overflow-hidden border border-border group shadow-lg">
                <div className="absolute inset-0 bg-[#354f3b] flex items-center justify-center">
                  ...
                  <span className="text-[10px] font-bold text-[#52bf6a] z-10">
                    Logo
                  </span>
                </div>
                {/* Badge "1" */}
          ...
          <PromptInputFooter className="px-5 pb-5 pt-0 flex justify-between items-center transition-all">
            ...
            <div className="flex items-center gap-4">
              ...
              />
              <PromptInputSubmit className="bg-primary text-primary-foreground rounded-full h-10 w-10 hover:opacity-90 transition-all flex items-center justify-center shadow-lg active:scale-95" />
            </div>
          </PromptInputFooter>
        </PromptInput>
      </div>
