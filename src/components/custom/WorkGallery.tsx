...
const works = [
  ...
  { id: 4, title: "STUDIOC", category: "Branding", image: "/images/studioc.png" },
  { id: 5, title: "Velotti", category: "Marketing", image: "/images/velotti.png" },
];

export function WorkGallery() {
  const [activeTab, setActiveTab] = useState("Logo");

  const filteredWorks = works.filter(work => work.category === activeTab || activeTab === "All");
    ...
    <div className="mt-20 w-full max-w-6xl mx-auto px-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        {filteredWorks.map((work) => (
          <div key={work.id} className="group relative aspect-square rounded-2xl overflow-hidden bg-[#111] border border-[#222]">
            <Image
              src={work.image}
              alt={work.title}
              fill
